...
# Import Home-grown
from cts_core import Node
from cts_core import Book, RawBook, Candle, Trades, TopLevel, Quote
from hermes.structs import Quotes
...
class DataNode(Node):
    ...
    def publish_quotes(self, data):
        ...
        pair = data[0][0]
        struct = Quotes(data)
        return self.publish('Quotes/%s' % pair, struct)
